...
export const BugDetail = ({ editBugSubmit, visibleBug, userEmail, users }) => {
                    ...
                    >
                        ...
                        <Grid item xs={12} sm={5}>
                            ...
                            <FormControl fullWidth>
                                ...
                                <Select
                                    name={BUG.ASSIGNED_TO}
                                    value={inputs[BUG.ASSIGNED_TO].value}
                                    onChange={handleOnChange}
                                    input={<Input />}
                                >
